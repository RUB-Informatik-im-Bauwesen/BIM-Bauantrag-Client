...
public class PO_Baumassenzahl extends ExtraktionsVorgang{
	
	protected String name;
	protected String value;
	protected String comment;
	
	private PO_Baumasse po_Baumasse;
	private double ratio;

	public PO_Baumassenzahl(PO_Baumasse po_Baumasse) {
		this.name = "Baumassenzahl";
		this.value = "";
		this.comment = "";
		
		this.po_Baumasse = po_Baumasse;
	}
				...
				if(grundstueckColl.size()==1) {
					...
					if (quantity!=null) {
						...
						if(quantity instanceof IfcQuantityArea.Ifc4) {
							...
							ratio = po_Baumasse.getBaumasse()/quantityArea.getAreaValue().getValue();
