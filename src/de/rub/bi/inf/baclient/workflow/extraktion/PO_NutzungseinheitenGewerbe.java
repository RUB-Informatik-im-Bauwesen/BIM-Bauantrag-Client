...
public class PO_NutzungseinheitenGewerbe extends ExtraktionsVorgang{
	...
	public PO_NutzungseinheitenGewerbe() {
		this.name = "NutzungseinheitenGewerbe";
		this.value = "";
		this.comment = "";
	}
