...
public class PO_WohnungenFreiberuflich extends ExtraktionsVorgang{
	...
	public PO_WohnungenFreiberuflich() {
		this.name = "WohnungenFreiberuflich";
		this.value = "";
		this.comment = "";
	}
