...
public class PO_WohneinheitenMietwohnungen extends ExtraktionsVorgang{
	...
	public PO_WohneinheitenMietwohnungen() {
		this.name = "WohneinheitenMietwohnungen";
		this.value = "";
		this.comment = "";
	}
