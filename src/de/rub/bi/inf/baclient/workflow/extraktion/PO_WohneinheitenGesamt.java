...
public class PO_WohneinheitenGesamt extends ExtraktionsVorgang{
	...
	public PO_WohneinheitenGesamt() {
		this.name = "WohneinheitenGesamt";
		this.value = "";
		this.comment = "";
	}
	...
	public void perform(ApplicationModelNode ifcModel, XPlanungModel xPlanModel) {
		if(ifcModel != null) {
		    ...
		    if (project instanceof IfcProject.Ifc4) {
		    	...
		    	allowedValues.add("WOHNEINHEIT_EIGENTUMSWOHNUNG");
		    	allowedValues.add("WOHNEINHEIT_MIETWOHNUNG");
		    	allowedValues.add("WOHNEINHEIT_SOZIALWOHNUNG");
		    	allowedValues.add("WOHNEINHEIT_GEWERBLICH");
		    	allowedValues.add("WOHNEINHEIT_FREIBERUFLICH");
		    	allowedValues.add("NUTZUNGSEINHEIT_GEWERBE");
