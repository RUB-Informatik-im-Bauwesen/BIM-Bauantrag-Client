...
public class PO_WohneinheitenSozialwohnungen extends ExtraktionsVorgang{
	...
	public PO_WohneinheitenSozialwohnungen() {
		this.name = "WohneinheitenSozialwohnungen";
		this.value = "";
		this.comment = "";
	}
