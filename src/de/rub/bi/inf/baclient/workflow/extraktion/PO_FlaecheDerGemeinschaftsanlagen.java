...
public class PO_FlaecheDerGemeinschaftsanlagen extends ExtraktionsVorgang{
	...
	public PO_FlaecheDerGemeinschaftsanlagen() {
		this.name = "FlaecheDerGemeinschaftsanlagen";
		this.value = "";
		this.comment = "";
	}
	...
	public void perform(ApplicationModelNode ifcModel, XPlanungModel xPlanModel) {
		if(ifcModel != null) {
		    ...
		    if (project instanceof IfcProject.Ifc4) {
		    	Collection<IfcObject.Ifc4> spaces = Util.Ifc4.getObjectsByProperty(ifcModel, IfcSpace.Ifc4.class, "BauantragGrundstücksflächen", "IstGemeinschaftsanlage", true);
