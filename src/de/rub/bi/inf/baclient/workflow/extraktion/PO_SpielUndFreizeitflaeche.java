...
public class PO_SpielUndFreizeitflaeche extends ExtraktionsVorgang{
	...
	public PO_SpielUndFreizeitflaeche() {
		this.name = "SpielUndFreizeitflaeche";
		this.value = "";
		this.comment = "";
	}
	...
	public void perform(ApplicationModelNode ifcModel, XPlanungModel xPlanModel) {
		if(ifcModel != null) {
		    ...
		    if (project instanceof IfcProject.Ifc4) {
		    	Collection<IfcObject.Ifc4> spaces = Util.Ifc4.getObjectsByProperty(ifcModel, IfcSpace.Ifc4.class, "BauantragGrundstücksflächen", "IstSpielUndFreizeitfläche", true);
