...
public class PO_Geschossflaechenzahl extends ExtraktionsVorgang{
	
	protected String name;
	protected String value;
	protected String comment;

	private PO_Geschossflaeche po_Geschossflaeche;
	private double ratio;
	
	public PO_Geschossflaechenzahl(PO_Geschossflaeche po_Geschossflaeche) {
		this.name = "Geschossflaechenzahl";
		this.value = "";
		this.comment = "";
		
		this.po_Geschossflaeche = po_Geschossflaeche;
				...
				if(grundstueckColl.size()==1) {
					...
					if (quantity!=null) {
						...
						if(quantity instanceof IfcQuantityArea.Ifc4) {
							...
							ratio = po_Geschossflaeche.getGeschossflaeche()/quantityArea.getAreaValue().getValue();
