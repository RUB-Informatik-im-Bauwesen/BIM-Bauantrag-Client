...
public class PO_WohneinheitenEigentumswohnungen extends ExtraktionsVorgang{
	...
	public PO_WohneinheitenEigentumswohnungen() {
		this.name = "WohneinheitenEigentumswohnungen";
		this.value = "";
		this.comment = "";
	}
